...
export const departments_API = `${domain}/departments`;
export const desginations_API = `${domain}/designations`;
export const leaves_API = `${domain}/leaves`;
export const attendance_API = `${domain}/attendance`;
